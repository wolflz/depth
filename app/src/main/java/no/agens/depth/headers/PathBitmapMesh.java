...
public class PathBitmapMesh
{
  ...
  private void startWaveAnim(Bitmap paramBitmap, float paramFloat, int paramInt)
  {
    ...
    this.pathOffset.addUpdateListener(new ValueAnimator.AnimatorUpdateListener()
    {
      public void onAnimationUpdate(ValueAnimator paramAnonymousValueAnimator)
      {
        PathBitmapMesh.this.pathOffsetPercent = ((Float)paramAnonymousValueAnimator.getAnimatedValue()).floatValue();
      }
    });
  ...
  public void matchVertsToPath(Path paramPath, float paramFloat1, float paramFloat2)
  {
    ...
    if (i < this.staticVerts.length / 2)
    {
      ...
      float f3 = (1.0E-6F + f2) / this.bitmap.getWidth();
      float f4 = (1.0E-6F + f2) / (paramFloat2 + this.bitmap.getWidth()) + this.pathOffsetPercent;
...
/* Location:              /home/andrew/works/KotSharedPreferences/a/classes_dex2jar.jar!/no/agens/depth/headers/PathBitmapMesh.class
