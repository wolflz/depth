  ...
  extends PathBitmapMesh
{
  ...
  public void matchVertsToPath(Path paramPath, float paramFloat)
  {
    ...
    if (j < this.staticVerts.length / 2)
    {
      ...
      float f4 = (1.0E-6F + f2) / (paramFloat + this.bitmap.getWidth()) + this.pathOffsetPercent;
...
/* Location:              /home/andrew/works/KotSharedPreferences/a/classes_dex2jar.jar!/no/agens/depth/headers/Foam.class
