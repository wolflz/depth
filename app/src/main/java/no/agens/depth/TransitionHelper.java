...
import no.agens.agtween.interpolators.BackOut;
import no.agens.agtween.interpolators.CircInOut;
import no.agens.agtween.interpolators.ExpoIn;
import no.agens.agtween.interpolators.ExpoOut;
import no.agens.agtween.interpolators.QuadInOut;
...
public class TransitionHelper
{
  ...
  {
    continueOutToRight((DepthLayout)paramView.findViewById(2131492979), 0.0F, 20);
    continueOutToRight((DepthLayout)paramView.findViewById(2131492968), 15.0F, 0);
    continueOutToRight((DepthLayout)paramView.findViewById(2131492987), 30.0F, 40);
    continueOutToRight((DepthLayout)paramView.findViewById(2131492981), 15.0F, 60);
    continueOutToRight((DepthLayout)paramView.findViewById(2131492985), 30.0F, 80);
  }
  ...
  public static void animateToMenuState(View paramView, AnimatorListenerAdapter paramAnimatorListenerAdapter)
  {
    ...
    exitAnimate((DepthLayout)paramView.findViewById(2131492979), 0.0F, 30.0F, 15L, 190, false);
    exitAnimate((DepthLayout)paramView.findViewById(2131492968), 15.0F, 20.0F, 30L, 170, false);
    exitAnimate((DepthLayout)paramView.findViewById(2131492987), 30.0F, 20.0F, 45L, 210, false);
    exitAnimate((DepthLayout)paramView.findViewById(2131492981), 15.0F, 20.0F, 60L, 230, false);
    exitAnimate((DepthLayout)paramView.findViewById(2131492985), 30.0F, 20.0F, 75L, 250, false).addListener(paramAnimatorListenerAdapter);
  ...
  @NonNull
  private static AnimatorListenerAdapter getShowStatusBarListener(DepthLayout paramDepthLayout)
  {
    new AnimatorListenerAdapter()
    {
      public void onAnimationEnd(Animator paramAnonymousAnimator)
      {
        ...
        TransitionHelper.makeAppFullscreen(this.val$target);
      }
    };
  }
  ...
  {
    exitAnimate((DepthLayout)paramView.findViewById(2131492979), 0.0F, 30.0F, 15L, 190, true);
    exitAnimate((DepthLayout)paramView.findViewById(2131492968), 15.0F, 20.0F, 30L, 170, true);
    exitAnimate((DepthLayout)paramView.findViewById(2131492987), 30.0F, 20.0F, 45L, 210, true);
    exitAnimate((DepthLayout)paramView.findViewById(2131492981), 15.0F, 20.0F, 60L, 230, true);
    exitAnimate((DepthLayout)paramView.findViewById(2131492985), 30.0F, 20.0F, 75L, 250, true);
    hideStatusBar(paramView);
  }
  
  public static void startIntroAnim(View paramView, AnimatorListenerAdapter paramAnimatorListenerAdapter)
  {
    introAnimate((DepthLayout)paramView.findViewById(2131492979), 0.0F, 30.0F, 15L, 180);
    introAnimate((DepthLayout)paramView.findViewById(2131492968), 15.0F, 20.0F, 30L, 170);
    introAnimate((DepthLayout)paramView.findViewById(2131492987), 30.0F, 20.0F, 45L, 190);
    introAnimate((DepthLayout)paramView.findViewById(2131492981), 15.0F, 20.0F, 60L, 200);
    introAnimate((DepthLayout)paramView.findViewById(2131492985), 30.0F, 20.0F, 75L, 210).addListener(paramAnimatorListenerAdapter);
  }
  
  public static void startRevertFromMenu(View paramView, AnimatorListenerAdapter paramAnimatorListenerAdapter)
  {
    revertFromMenu((DepthLayout)paramView.findViewById(2131492979), 30.0F, 10, 0.0F);
    revertFromMenu((DepthLayout)paramView.findViewById(2131492968), 20.0F, 0, 0.0F);
    revertFromMenu((DepthLayout)paramView.findViewById(2131492987), 20.0F, 20, 6.0F);
    revertFromMenu((DepthLayout)paramView.findViewById(2131492981), 20.0F, 30, 1.0F);
    revertFromMenu((DepthLayout)paramView.findViewById(2131492985), 20.0F, 40, 2.0F).addListener(paramAnimatorListenerAdapter);
...
/* Location:              /home/andrew/works/KotSharedPreferences/a/classes_dex2jar.jar!/no/agens/depth/TransitionHelper.class
