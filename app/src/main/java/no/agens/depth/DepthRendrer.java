  ...
  extends RelativeLayout
{
  ...
  private void drawCornerBaseShape(DepthLayout paramDepthLayout, Canvas paramCanvas, float[] paramArrayOfFloat)
  {
    ...
    paramCanvas.concat(this.matrix);
    this.edgePath.reset();
    this.edgePath.addRoundRect(0.0F, 0.0F, paramDepthLayout.getWidth(), paramDepthLayout.getHeight(), paramDepthLayout.getWidth() / 2.0F, paramDepthLayout.getHeight() / 2.0F, Path.Direction.CCW);
...
/* Location:              /home/andrew/works/KotSharedPreferences/a/classes_dex2jar.jar!/no/agens/depth/DepthRendrer.class
