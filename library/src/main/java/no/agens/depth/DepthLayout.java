  ...
  extends RelativeLayout
{
  ...
  private void initView(AttributeSet paramAttributeSet)
  {
    ...
    if (paramAttributeSet != null)
    {
      ...
      this.edgePaint.setColor(localTypedArray.getInt(1, -1));
      setIsCircle(localTypedArray.getBoolean(0, false));
      this.depth = localTypedArray.getDimension(2, 2.0F * getResources().getDisplayMetrics().density);
      this.customShadowElevation = localTypedArray.getDimension(3, 0.0F);
    }
    for (;;)
    {
...
/* Location:              /home/andrew/works/KotSharedPreferences/a/classes_dex2jar.jar!/no/agens/depth/DepthLayout.class
